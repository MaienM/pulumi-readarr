...
export class DownloadClientConfig extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: DownloadClientConfigArgs | DownloadClientConfigState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            if ((!args || args.removeCompletedDownloads === undefined) && !opts.urn) {
                throw new Error("Missing required property 'removeCompletedDownloads'");
            }
            if ((!args || args.removeFailedDownloads === undefined) && !opts.urn) {
                throw new Error("Missing required property 'removeFailedDownloads'");
            }
