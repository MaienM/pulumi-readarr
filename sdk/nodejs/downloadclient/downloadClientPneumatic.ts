 ...
 *
 * const example = new readarr.downloadclient.DownloadClientPneumatic("example", {
 *     enable: true,
 *     name: "Example",
 *     nzbFolder: "/nzb/",
 *     priority: 1,
 ...
 *
 * ```sh
 *  $ pulumi import readarr:DownloadClient/downloadClientPneumatic:DownloadClientPneumatic example 1
 * ```
 */
export class DownloadClientPneumatic extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'readarr:DownloadClient/downloadClientPneumatic:DownloadClientPneumatic';
