 ...
 * ```
 */
export class ImportListGoodreadsList extends pulumi.CustomResource {
    /**
     * Get an existing ImportListGoodreadsList resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ImportListGoodreadsListState, opts?: pulumi.CustomResourceOptions): ImportListGoodreadsList {
        return new ImportListGoodreadsList(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'readarr:ImportLists/importListGoodreadsList:ImportListGoodreadsList';

    /**
     * Returns true if the given object is an instance of ImportListGoodreadsList.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ImportListGoodreadsList {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ImportListGoodreadsList.__pulumiType;
    }
    ...
    /**
     * Create a ImportListGoodreadsList resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: ImportListGoodreadsListArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ImportListGoodreadsListArgs | ImportListGoodreadsListState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ImportListGoodreadsListState | undefined;
            ...
            const args = argsOrState as ImportListGoodreadsListArgs | undefined;
        ...
        super(ImportListGoodreadsList.__pulumiType, name, resourceInputs, opts);
    }
}

/**
 * Input properties used for looking up and filtering ImportListGoodreadsList resources.
 */
export interface ImportListGoodreadsListState {
    /**
     * Enable automatic add flag.
     */
...
/**
 * The set of arguments for constructing a ImportListGoodreadsList resource.
 */
export interface ImportListGoodreadsListArgs {
    /**
     * Enable automatic add flag.
     */
    enableAutomaticAdd?: pulumi.Input<boolean>;
