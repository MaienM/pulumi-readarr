 ...
 * ```
 */
export class ImportListGoodreadsOwnedBooks extends pulumi.CustomResource {
    /**
     * Get an existing ImportListGoodreadsOwnedBooks resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ImportListGoodreadsOwnedBooksState, opts?: pulumi.CustomResourceOptions): ImportListGoodreadsOwnedBooks {
        return new ImportListGoodreadsOwnedBooks(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'readarr:ImportLists/importListGoodreadsOwnedBooks:ImportListGoodreadsOwnedBooks';

    /**
     * Returns true if the given object is an instance of ImportListGoodreadsOwnedBooks.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ImportListGoodreadsOwnedBooks {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ImportListGoodreadsOwnedBooks.__pulumiType;
    }
    ...
    /**
     * Create a ImportListGoodreadsOwnedBooks resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: ImportListGoodreadsOwnedBooksArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ImportListGoodreadsOwnedBooksArgs | ImportListGoodreadsOwnedBooksState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ImportListGoodreadsOwnedBooksState | undefined;
            ...
            const args = argsOrState as ImportListGoodreadsOwnedBooksArgs | undefined;
        ...
        super(ImportListGoodreadsOwnedBooks.__pulumiType, name, resourceInputs, opts);
    }
}

/**
 * Input properties used for looking up and filtering ImportListGoodreadsOwnedBooks resources.
 */
export interface ImportListGoodreadsOwnedBooksState {
    /**
     * Access token.
     */
...
/**
 * The set of arguments for constructing a ImportListGoodreadsOwnedBooks resource.
 */
export interface ImportListGoodreadsOwnedBooksArgs {
    /**
     * Access token.
     */
    accessToken: pulumi.Input<string>;
